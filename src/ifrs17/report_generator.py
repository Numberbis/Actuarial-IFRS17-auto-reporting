...
class MarkdownReportGenerator:
    ...
    def _build_report(self, results: List[IFRS17Result], total_liability: float,
        ...
        md.append(f"- Net Insurance Result: **${total_revenue - total_expense:,.2f}**\n")
        ...
        md.append(f"| Risk Adjustment | {total_risk_adj:,.2f} |\n")
        ...
        for result in results:
            ...
            md.append(f"| Risk Adjustment | {result.risk_adjustment:,.2f} |\n")
            ...
            md.append(f"| **Net Insurance Result** | **{result.insurance_revenue - result.insurance_service_expense:,.2f}** |\n")
        ...
        # Footer
        md.append("\n---\n")
        md.append(f"\n*Report generated automatically on {date.today().strftime('%Y-%m-%d')}*\n")
